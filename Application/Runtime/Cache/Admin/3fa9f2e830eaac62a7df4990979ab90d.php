...
<html>
	<head>
		<meta charset="utf-8">
		<title>欢迎界面</title>
		<link type="text/css" rel="stylesheet" href="/mywebTP/Public/easyui/themes/bootstrap/easyui.css">
		<link type="text/css" rel="stylesheet" href="/mywebTP/Public/easyui/themes/icon.css">
		<script type="text/javascript" src="/mywebTP/Public/js/jquery-1.9.1.min.js"></script>
		<script type="text/javascript" src="/mywebTP/Public/easyui/jquery.easyui.min.js"></script>
		<script type="text/javascript" src="/mywebTP/Public/easyui/locale/easyui-lang-zh_CN.js"></script>
		<style type="text/css">
	...
	<body class="easyui-layout">   
        ...
        <div id='tabs' data-options="region:'center'" class="easyui-tabs" style="background:#eee;">
        	<div title="温馨提示" style="background-image: url(/mywebTP/Public/img/body-bg.gif);">
